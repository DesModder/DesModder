...
multiline-opt-updateLayoutWhileTyping-name = Update Layout while Typing
multiline-opt-updateLayoutWhileTyping-desc = Split expressions onto multiple lines and (if applicable) auto-align grids in response to typing.
...
multiline-opt-autoInsertLinebreaks-name = Auto Insert Linebreaks 
multiline-opt-autoInsertLinebreaks-desc = Automatically figure out where to put line breaks. Use Ctrl+M or "Alter Layout by Typing" to trigger this.
...
multiline-opt-autoAlignGrids-name = Auto-Align Grids
multiline-opt-autoAlignGrids-desc = Automatically center-align the elements in any multi-line list of comma-separated values, similar to how one would align a table or a matrix. Use Ctrl+M or "Alter Layout by Typing" to trigger this.
