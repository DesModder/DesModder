...
multiline-opt-alterLayoutWhileTyping-name = Alter Layout while Typing
multiline-opt-alterLayoutWhileTyping-desc = Split expressions onto multiple lines and (if applicable) auto-align grids in response to typing.
