	import { Calc, jquery } from "desmodder";
	...
	function typeInTextArea(
		...
		elm: null | Element = document.activeElement
	) {
	...
	function pasteHandler(e:ClipboardEvent) {
		...
		if (pasteData !== '' && Calc.controller.getItemModel(Calc.selectedExpressionId).type == "expression") {
