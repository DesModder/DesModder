...
const configFlags = {
	...
	derivativeLoopLimit: true // converts (d^#/dx^#) to (d/dx)... # times, bottlenecked to 10 iterations
}
...
function wolfram2desmos(input) {
	...
	while (configFlags.reciprocalExponents2Surds && findFinal(/\^\{\\frac\{1\}\{[A-z\d\s\.\	+\-\*]*\}\}/g) != -1) {
	...
	while (find(/Ｍ/) != -1) {
		...
		if (selection.search(/[^\d]*/g) != -1) {
			...
			if (selection <= 10 && configFlags.derivativeLoopLimit) {
				replace(/Ｍ/, "");
...
console.log("wolfram2desmos loaded properly ✔️\n_   _ _____ ___  _   _ _____ _   _ ___________  ___  \n| | | |  ___/ _ \\| | | |  ___| \\ | |_   _| ___ \\/ _ \\ \n| |_| | |__/ /_\\ | | | | |__ |  \\| | | | | |_/ / /_\\ \\\n|  _  |  __|  _  | | | |  __|| . ` | | | |    /|  _  |\n| | | | |__| | | \\ \\_/ | |___| |\\  |_| |_| |\\ \\| | | |\n\\_| |_\\____\\_| |_/\\___/\\____/\\_| \\_/\\___/\\_| \\_\\_| |_/");
	...
	export{ wolfram2desmos, isIllegalASCIIMath, configFlags }
