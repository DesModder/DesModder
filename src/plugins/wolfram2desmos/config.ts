export const configList = [
  {
    ...
    description:
      "Converts fractional powers less than one to a radical equivalent (surd)",
    type: "boolean",
    default: false,
  },
  {
    ...
    description:
      "Expands the nth derivative of Leibniz notation into repeated derivatives (limited to 10).",
    type: "boolean",
    default: true,
  },
